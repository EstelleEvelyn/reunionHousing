...
def createCSV(areaList):
  ...
  fieldnames = ["Code", "Building", "Room", "Room Type", "Capacity", "Guest", "Notes", "Adj Rm", "Room Key", "Outside Key", "Keycard #", "Card Returned", "Key Returned", "Key Notes"]
...
def extractRoomData(masterListCSV):
  ...
  housingKeyDict = {"ALLE":"Unassigned", "BENT":"Benton/Huntington \'08", "BERG":"Berg \'08/Hunt Cottage \'93", "BRKS":"North TH \'84, \'94", "BURT":"Burton \'94", "CASS":"Cassat \'79, \'69, \'99", "CHAN":"Fac Club/Chaney \'08", "CLWL":"South TH \'74", "COLR":"North TH \'84, \'94", "DAVI":"Davis \'54, \'59", "DIXN":"South TH \'74", "DOUG":"Parish/Douglas \'09", "DOWH":"South TH \'74", "EUGS":"North TH \'84, \'94", "EVAN":"Evans \'04", "FACL":"Fac Club/Chaney \'08","FARM":"Unassigned", "GFRT":"Unassigned", "GHUE":"Goodhue \"14", "HALL":"North TH \'84, \'94", "HCTG":"Berg \'08/Hunt Cottage \'93", "HNRK":"South TH \'74", "HNTH":"South TH \'74", "HUNT":"Benton/Huntington \'08", "JEWE":"Jewett/Page W/Rice/Wade \'09", "JMES":"James \'99", "MUSS":"Musser - Student Housing", "MYER":"Myers \'89", "NASN":"North TH \'84, \'94", "NOUR":"Nourse \'64, \'69", "OWNS":"North TH \'84, \'94", "PAGE":"Unassigned", "PAGW":"Jewett/Page W/Rice/Wade \'09", "PARR":"Unassigned", "PREN":"Unassigned", "PRSH":"Parish/Douglas \'09", "RICE":"Jewett/Page W/Rice/Wade \'09", "SCOT":"North TH \'84, \'94", "SEVY":"Sevy \'94", "STIM":'Unassigned', "WADE":"Jewett/Page W/Rice/Wade \'09", "WATS":"Watson \'69", "WILM":"Unassigned", "WILS":"Unassigned"}
  ...
  with open(masterListCSV, 'r') as masterFile:
    ...
    for room in reader:
      ...
      with open(areaName+'.csv', 'a') as subFile:
        writer = csv.DictReader(subFile, fieldnames=fieldnames)
        for i in range capacity:
          writer.writerow({"Code":room["Bldg/Room"], "Building":room["Building Code"], "Room":room["Building Code"][5:], "Room Type":room["Room Type"], "Capacity":capacity, "Adj Rm":room["Adjoining Rooms"], "Room Key":room["Room Key"], "Outside Key":room["Outside Key"]})


def main():

  #Only change the years in this list
  areaList = ["Unassigned", "Benton/Huntington \'08", "Berg \'08/Hunt Cottage \'93", "North TH \'84, \'94", "Burton \'94", "Cassat \'79, \'69, \'99", "Fac Club/Chaney \’08", "South TH \'74", "Davis \'54, \'59", "Parish/Douglas \'09", "Evans \'04", "Goodhue \'14", "Jewett/Page W/Rice/Wade \'09", "James \'99", "Musser - Student Housing", "Myers \'89", "Nourse \'64, \'69", "Sevy \'94", "Watson \'69"]
